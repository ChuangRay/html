...
function changelist1()
{
      ...
      {
            case "YES":
            document.getElementById("abroad_q1").innerHTML='<ol><li>入境日期 <INPUT type="date" name="e_day"><br></li><li>最近入境台灣之來源地區 <INPUT type="text" name="source"><br></li><li>搭乘班機航空公司與編號 <INPUT type="text" name="flight"><br></li></ol>'
            break;
            case "NO":
